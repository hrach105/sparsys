...
function my_theme_enqueue_styles_media() {
    // Register the stylesheet
    wp_register_style( 'media', get_template_directory_uri() . '/assets/css/media.css', array(), '1.0', 'all' );

    // Enqueue the stylesheet
    wp_enqueue_style( 'media' );
}
add_action( 'wp_enqueue_scripts', 'my_theme_enqueue_styles_media' );
...
function my_theme_enqueue_scripts() {
    ...
    // Register and enqueue custom-script.js
    wp_register_script('custom-script-js', get_template_directory_uri() . '/assets/js/script.js', array('jquery'), '1.0', true);
...
function register_post_types(){
    ...
    register_post_type( 'Sliders', [
        ...
        'labels' => [
            ...
            'menu_name'          => 'Sliders', // название меню
        ],
        'description'            => '',
        'public'                 => true,
